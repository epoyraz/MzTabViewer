 ...
 * @author Enes Poyraz
 */
public class MzTabViewerNodePlugin extends Plugin {
    // The shared instance.
    private static MzTabViewerNodePlugin plugin;

    /**
     * The constructor.
     */
    public MzTabViewerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MzTabViewerNodePlugin getDefault() {
        return plugin;
    }
